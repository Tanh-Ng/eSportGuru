            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                {language === "en"
                  ...
                  : "Tham gia cộng đồng của chúng tôi hôm nay"}
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              ...
              >
                ...
                <span className="text-slate-700 dark:text-slate-300 font-medium">
                  {language === "en" ? "Sign up with Google" : "Đăng ký với Google"}
                </span>
              </button>
              ...
              >
                ...
                <span className="text-slate-700 dark:text-slate-300 font-medium">
                  {language === "en" ? "Sign up with Facebook" : "Đăng ký với Facebook"}
                </span>
              </button>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400">
                  {language === "en" ? "Or sign up with email" : "Hoặc đăng ký với email"}
                </span>
              </div>
            </div>
              ...
              >
                {loading ? (
                  <>
                    ...
                    {language === "en" ? "Creating account..." : "Đang tạo tài khoản..."}
                  </>
                ) : (
                  (language === "en" ? "Create Account" : "Tạo Tài Khoản")
                )}
